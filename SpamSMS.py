...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Kalo Kurang Masuk Ke Github Gua Dulu Liat Dulu Siapa Tau Ada Yang Pengen Tools Tambahan")
    time.sleep(1)
    os.system("xdg-open https://github.com/Mr15XCYBE")
    time.sleep(5)
    os.system("clear")
# -------{ bang Minta Diamond FF :v }-------- #
def mr_dark_input():
    subs_mr_dark = input("  ➤ ")
    if subs_mr_dark == "1":
         dark_point = 1
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   ╚═╝┴  ┴ ┴┴ ┴     ╚═╝└─┘└┴┘")
    print ("")
    print ("    > Author  : Mr.15XCyber ")
    print ("    > Team    : CYBER SADBOY TEAM ")
    print ("    > Github  : github https://github.com/Mr15XCYBE ")
    print ("")
